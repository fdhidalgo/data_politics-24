...
In this case, the p-value is 0 as there are no values in the sampling distribution that are as extreme or more extreme than the actual test statistic.
...
ggplot(perm_df, aes(x = permuted_diff)) +
