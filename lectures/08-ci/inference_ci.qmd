...
- A 95% CI will:
  ...
  - Lie to you 5% of the time (not contain the true parameter or estimand 5% of the time).
...
```{=html}
<iframe width="1000" height="600" src="https://rpsychologist.com/d3/ci/" title="CI Simulation"></iframe>
```
